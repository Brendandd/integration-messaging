...
/**
 * Base class for all routes.  A route is composed of components and determines the message flow within a system.
 * 
...
public abstract class BaseRoute {
	...
	/**
	 * Add the message flow from a source component to one or more destination components.
	 * 
