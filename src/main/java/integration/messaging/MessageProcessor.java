...
public class MessageProcessor {
	 ...
	 * @throws Exception
	 */
	private MessageFlowStepDto storeMessageFlow(Exchange exchange, long componentRouteId, DirectionEnum direction) throws Exception {
		// The from message flow step id can be null if it is the original inbound message.
		...
		return messagingFlowService.recordMessageFlow(componentRouteId, messageContent, headers, fromMessageFlowId, contentType, direction);
	}
	...
	/**
	 * records an external message flow event.  An external event will send a message to an external system.
	 * 
	 * @param exchange
	 */
