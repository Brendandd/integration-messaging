...
public class RouteTemplates extends RouteBuilder {	
	...
	public void configure() throws Exception {
		...
		routeTemplate("readMessageFromInboundProcessingCompleteQueueTemplate")
		...
		// The outbound processing for a inbound communication point.
		routeTemplate("handleInboundProcessingCompleteEventTemplate")
			.templateParameter("isOutboundRunning")
			.templateParameter("componentPath")
			.from("direct:handleInboundProcessingCompleteEvent-{{componentPath}}")
			.routeId("handleInboundProcessingCompleteEvent-{{componentPath}}")
			.routeGroup("{{componentPath}}")
			.transacted()
		...
		routeTemplate("componentInboundFilterableTopicConsumer")
		...
		routeTemplate("outboundProcessingCompleteTopicConsumer")
			.templateParameter("componentPath")
			.from("direct:handleOutboundProcessCompleteEvent-{{componentPath}}")
			.routeId("handleOutboundProcessCompleteEvent-{{componentPath}}")
			.routeGroup("{{componentPath}}")
			.transacted("")
		...
		// The outbound processing for a inbound communication point.
		routeTemplate("routeConnectorPointOutboundProcessorTemplate")
	        .templateParameter("isOutboundRunning")
	       .templateParameter("componentPath")
	       .templateParameter("componentRouteId")
	       .from("direct:outboundProcessor-{{componentPath}}")
