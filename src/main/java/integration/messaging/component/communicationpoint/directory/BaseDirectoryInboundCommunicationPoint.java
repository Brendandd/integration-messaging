...
/**
 * Base class for all directory input communication points.  This components reads the file, stores
 * it and writes and event  No other processing should be done here.
 * 
