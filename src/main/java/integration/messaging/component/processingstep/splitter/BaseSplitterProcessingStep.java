...
/**
 * Base class for splitting a message into 1 or more messages.  A splitter is only responsible for splitting
 * a message and no transformations should be done as part of the splitting process.
 */
