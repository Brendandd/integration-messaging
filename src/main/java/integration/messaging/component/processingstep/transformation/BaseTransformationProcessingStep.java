...
public abstract class BaseTransformationProcessingStep extends ProcessingStep {
	...
	/**
	 * The transformer.  A transformer is responsible for transforming the message.  A transformer can also filter a message is required.
	 * 
	 * @return
	 */
