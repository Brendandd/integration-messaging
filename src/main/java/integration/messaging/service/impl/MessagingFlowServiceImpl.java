...
public class MessagingFlowServiceImpl implements MessagingFlowService {
	 ...
	 */
	@Override
	public MessageFlowStepDto recordAck(long componentRouteId, Map<String, Object> headers, String messageContent, Long fromMessageFlowStepId) {		
		...
		MessageFlowStep messageFlow = createMessageFlowStep(componentRouteId, message, fromMessageFlow,DirectionEnum.OUTBOUND,fromMessageFlow.get().getMessageFlowGroup());
	 ...
	 */
	@Override
	public MessageFlowStepDto recordMessageFlow(long componentRouteId, String messageContent, Map<String, Object> headers, Long fromMessageFlowStepId, String contentType, DirectionEnum direction) {		
		Optional<MessageFlowStep>fromMessageFlow = null;
		...
		MessageFlowStep messageFlowStep = createMessageFlowStep(componentRouteId, message, fromMessageFlow, direction, messageFlow);
	 ...
	 * @return
	 */
	private MessageFlowStep createMessageFlowStep(long componentRouteId, Message message, Optional<MessageFlowStep> from, DirectionEnum direction, MessageFlowGroup messageFlow) {
